<form class="form-horizontal" role="form" id="employer" method="POST" action="<?= BASEURL ?>employer/employer_validation" autocomplete="on" enctype="multipart/form-data" >
	...
	<div class="col-md-10 col-md-offset-2">
			...
			<div class="form-group">
				 ...
				 <div class="form-group">
				   ...
				   <div class="col-sm-6">
				     <input type="text" name="country" class="form-control" placeholder="Country" value="<?php echo set_value('country'); ?>" /> <?php echo form_error('country'); ?>
				   </div>
				 </div>
		        ...
		        <div class="form-group">
				   ...
				   <div class="col-sm-6">
				     <input type="text" name="city" class="form-control" placeholder="City" value="<?php echo set_value('city'); ?>" /> <?php echo form_error('city'); ?>
				   </div>
				 </div>
...
<!-- <div class="container">
	<div class="row">
		<div class="col-md-10 col-md-offset-2">
			<form class="form-horizontal" role="form" id="employer" method="POST" 
						action="<?= BASEURL ?>employer/employer_validation" autocomplete="on" enctype="multipart/form-data" >
		        <h3 class="form-signin-heading" id="employer-heading">Employer Registration</h3>
		        <br>
		        <div class="form-group">
				   <label for="company_name" class="col-sm-2 control-label" >Company Name:</label>
				   <div class="col-sm-6">
		        ...
		        <div class="form-group">
				   <label for="picture_logo" class="col-sm-2 control-label" >Picture Logo:</label>
				   <div class="col-sm-6">
				     <input type="file" name="picture_logo" class="form-control" value="<?php echo set_value('picture_logo'); ?>" /> <?php echo form_error('picture_logo'); ?>
				   </div>
				 </div>
